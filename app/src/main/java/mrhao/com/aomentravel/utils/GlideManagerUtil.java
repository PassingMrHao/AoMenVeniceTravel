...
public class GlideManagerUtil {
    ...
    public GlideManagerUtil(Builder builder){
    ...
    public GlideManagerUtil addLoadLstner(BitmapListener listener){
    ...
    public static class Builder{
        ...
        public GlideManagerUtil builder(){
            return new GlideManagerUtil(this);
        }
