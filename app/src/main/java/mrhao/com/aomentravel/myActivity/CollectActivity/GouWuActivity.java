...
public class GouWuActivity extends BaseActivity {
    ...
    TextView titleText;
    @BindView(R.id.gv_gouwulist)
    GridView gvGouwulist;
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response) {
                        ...
                        for (int i = 0; i < bean.getData().size(); i++) {
                            if (bean.getData().get(i).getType().equals("购物商场")) {
                        ...
                        ad = new Gird_CollectAdapter(GouWuActivity.this, list, new Gird_CollectAdapter.Cancle() {
                            @Override
                            public void quxiao(final String title) {
                                BaseDialogUtil.normalDialog(GouWuActivity.this, "取消", "是否取消本收藏", new BaseDialogUtil.ShowDialogListener() {
                                    @Override
