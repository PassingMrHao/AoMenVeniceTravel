...
public class ZheKouActivity extends BaseActivity {
    ...
    TextView titleText;
    @BindView(R.id.gv_zhekoulist)
    GridView gvZhekoulist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zhe_kou);
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response) {
                        ...
                        for (int i = 0; i < bean.getData().size(); i++) {
                            if (bean.getData().get(i).getType().equals("折扣")) {
                        ...
                        ad = new Gird_CollectAdapter(ZheKouActivity.this, list, new Gird_CollectAdapter.Cancle() {
                            @Override
                            public void quxiao(final String title) {
                                BaseDialogUtil.normalDialog(ZheKouActivity.this, "取消", "是否取消本收藏", new BaseDialogUtil.ShowDialogListener() {
                                    @Override
