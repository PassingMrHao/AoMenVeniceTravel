                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response) {
                        ...
                        for (int i = 0; i < bean.getData().size(); i++) {
                            if (bean.getData().get(i).getType().equals("娱乐场所")) {
                        ...
                        ad = new Gird_CollectAdapter(YuLeActivity.this, list, new Gird_CollectAdapter.Cancle() {
                            @Override
                            public void quxiao(final String title) {
                                BaseDialogUtil.normalDialog(YuLeActivity.this, "取消", "是否取消本收藏", new BaseDialogUtil.ShowDialogListener() {
                                    @Override
