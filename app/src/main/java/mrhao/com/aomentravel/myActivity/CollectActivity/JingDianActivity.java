...
public class JingDianActivity extends BaseActivity {
    ...
    TextView titleText;
    @BindView(R.id.gv_jingdianlist)
    GridView gvJingdianlist;
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response) {
                        ...
                        for (int i = 0; i < bean.getData().size(); i++) {
                            if (bean.getData().get(i).getType().equals("旅游景点")) {
                        ...
                        ad = new Gird_CollectAdapter(JingDianActivity.this, list, new Gird_CollectAdapter.Cancle() {
                            @Override
                            public void quxiao(final String title) {
                                BaseDialogUtil.normalDialog(JingDianActivity.this, "取消", "是否取消本收藏", new BaseDialogUtil.ShowDialogListener() {
                                    @Override
