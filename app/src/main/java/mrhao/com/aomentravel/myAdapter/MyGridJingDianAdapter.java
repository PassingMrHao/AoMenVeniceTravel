...
public class MyGridJingDianAdapter extends BaseAdapter {

    Context context;
    List<MacaoTravelBean2.AttractionTripTagsBean> list;


    public MyGridJingDianAdapter(Context context, List<MacaoTravelBean2.AttractionTripTagsBean> list) {
    ...
    public View getView(int i, View v, ViewGroup viewGroup) {
        ...
        v = LayoutInflater.from(context).inflate(R.layout.mygridview_jingdian, viewGroup, false);
        TextView name = v.findViewById(R.id.yinxiang_name);
       RecyclerView recy= v.findViewById(R.id.yinxiang_recycle);
