...
public class Grid_PlayAd extends BaseAdapter {
    ...
    public View getView(final int i, View v, ViewGroup viewGroup) {
        ...
        GlideApp.with(context).load(list.get(i).getCoverImage()).format(DecodeFormat.PREFER_RGB_565).override(400,240).thumbnail(0.1f).dontAnimate().diskCacheStrategy(DiskCacheStrategy.RESOURCE).into(im);
        ...
        lay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent hao = new Intent(context, PlayDetailsActivity.class);
                Bundle b=new Bundle();
                b.putString("bt",list.get(i).getTitle());
                b.putInt("paly_objectId",list.get(i).getObjectId());
