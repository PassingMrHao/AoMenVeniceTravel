...
public class PlayDetailsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        objId = b.getInt("paly_objectId");
        baseurl = "https://api.koudaihk.com:4432/api/info/shareDetailsMC.html?objectId=" + objId + "&channelId=1211&model=801700";
        setBaseDate();
    }
    ...
    private void setBaseDate() {
        ...
        imgCollect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                BaseDialogUtil.normalDialog(PlayDetailsActivity.this, "收藏", "喜欢就加入收藏吧，可在【发现——我的收藏】中查看", new BaseDialogUtil.ShowDialogListener() {
                    @Override
                    public void Positive() {
                        if (sp.getString("username", "").equals("")) {
                            Toast.makeText(PlayDetailsActivity.this, "请先登录", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(PlayDetailsActivity.this, MobLoginActivity.class));
                        } else {
                                    ...
                                    .execute(new StringCallback() {
                                        ...
                                        public void onResponse(String response) {
                                            ...
                                            if (response.contains("\"code\":300")) {
                                                Toast.makeText(PlayDetailsActivity.this, "亲，已经收藏过了", Toast.LENGTH_SHORT).show();
                                            } else if (response.contains("\"code\":200")) {
                                                Toast.makeText(PlayDetailsActivity.this, "收藏成功！", Toast.LENGTH_SHORT).show();
                                            } else if (response.contains("\"code\":400")) {
                                                Toast.makeText(PlayDetailsActivity.this, "收藏失败！", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
